 ...
 * 
 * Adicionar a solicitação do percentual de frequencia, logo após a solicitação da nota 3
 * Adicionar a condição para reprovar o aluno por frequencia inferior a 75%
 * 
 * Critérios de reprovação:
 * - Mesmo que o aluno tenha média >= 6 se o percentual de frequencia for menor que 75 o aluno está reprovado
 * - Média menor que 6 o aluno está reprovado
 * - Média maior ou igual a 6 e frequencia maior ou igual a 74 aluno está aprovado
 *
 ...
 *
 * Adicionar uma condição para verificar se a idade informada é negativa. Caso seja, exibir uma mensagem de erro.
 */
